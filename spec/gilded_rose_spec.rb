...
describe GildedRose do
  ...
  describe "Aged Brie" do
    it "will decrease in sell_in but increase in quality" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 11
      expect(guildedrose.sell_in).to eq 9
    end
    ...
    it "will increase in quality as sell_in decreases" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 14
      expect(guildedrose.sell_in).to eq 22
    end

    it "quality above 50 will not change but sell_in still decreases by 1" do
      items = [Item.new("Aged Brie", 10, 50)]
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 50
      expect(guildedrose.sell_in).to eq 9
    end
    ...
    it "quality will increase by 2 when sell_in is 0" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 12
      expect(guildedrose.sell_in).to eq -1
    end
    ...
    it "sell_in is 0, quality will increase by 2" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 24
      expect(guildedrose.sell_in).to eq -1
    end
    ...
    it "quality will never increase above 50" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 50
      expect(guildedrose.sell_in).to eq 4
    end
  end
  ...
  describe "Backstage passes to a TAFKAL80ETC concert" do
    it "when sell_in is 5 or less, quality will increase by 3" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 13
    end

    it "when sell_in is 5 or less, quality will increase by 3" do
      items = [Item.new("Backstage passes to a TAFKAL80ETC concert", 3, 15)]
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 18
    end
    ...
    it "when sell_in is 10 or less, quality will increase by 2" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 21
    end
    ...
    it "when sell_in is more than 10, quality will increase by 1" do
      ...
      guildedrose = GildedRose.new(items).update_quality()
      expect(guildedrose.quality).to eq 20
      expect(guildedrose.sell_in).to eq 17
    end
